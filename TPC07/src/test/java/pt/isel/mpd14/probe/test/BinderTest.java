...
import pt.isel.mpd14.probe.BindStrUCase;
...
public class BinderTest extends TestCase{
    ...
    public void test_bind_fields_string_to_uppercase() throws Exception
    {
        /*
         Arrange
        */
        Map<String, Object> v = new HashMap<>();
        v.put("name", "default name");
        v.put("id", 657657);
        ...
        */
        ...
        StudentDto s2 = new Binder<>(StudentDto.class, new BindStrUCase<StudentDto>(new BindField()))
                .bindTo(v);
        System.out.println(s2);
        /*
          Assert
        */
        ...
        Assert.assertEquals(((String)v.get("name")).toUpperCase(), s2.name);
